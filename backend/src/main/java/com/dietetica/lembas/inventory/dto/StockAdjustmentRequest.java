 ...
 * The reason is mandatory for traceability. The quantity is validated in the
 * service to be non-zero since {@code @PositiveOrZero} would reject the
 * negative values needed for consumption and waste types.</p>
 *
