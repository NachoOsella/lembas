...
import type {
  ...
  SupplierRequest,
} from '@features/suppliers/domain/supplier';
...
export class SupplierService {
  ...
  updateSupplierProduct(
    id: number,
    request: SupplierProductRequest,
  ...
  listCostHistory(id: number): Observable<SupplierProductCostHistoryPage> {
    return this.http.get<SupplierProductCostHistoryPage>(
      `${this.supplierProductsUrl}/${id}/cost-history`,
    );
  }
