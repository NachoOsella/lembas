...
import type { CreateOnlineOrderRequest, OrderCreated } from './customer-order';
import { CustomerOrderService } from './customer-order';
import type { OrderSummary, OrderDetail } from '@features/orders/domain/order';
