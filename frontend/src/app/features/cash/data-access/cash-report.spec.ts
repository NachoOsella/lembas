...
import type { CashSessionHistoryDto, CashReportDto } from '@features/cash/domain/cash-report';
...
describe('CashReportService', () => {
  ...
  it('hits the history endpoint with the default filters', () => {
    ...
    const req = httpMock.expectOne((r) => r.url === '/api/admin/reports/cash-sessions');
