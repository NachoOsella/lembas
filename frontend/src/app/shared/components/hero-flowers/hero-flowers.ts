...
/**
 * Decorative Lembas leaf accents for hero sections.
 * Each leaf is wrapped in a positioning div (static transform) and an inner
 * animated div (translate only), so rotations/flips never conflict with animation.
 *
 * Usage: `<app-hero-flowers />` inside a relatively-positioned hero container.
 */
@Component({
  ...
  template: `
    <div class="hero-flowers pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
      ...
      <!-- Leaf 3: Small, center bottom — squished, rotated -->
      ...
      <!-- Leaf 4: Medium, center-right top — flipped, upright -->
      ...
      <!-- Leaf 5: Small, right bottom — tall, tilted -->
      ...
      <!-- Leaf 6: Tiny, far-right bottom — wide, flipped -->
  ...
  styles: `
    ...
    /* ── Positioning wrappers (static transform, never animated) ── */

    .hero-flowers__pos {
      position: absolute;
    }

    /* 1: Large, far-left bottom — upright */
    .hero-flowers__pos--1 {
    ...
    /* 2: Medium, left-center top — flipped + tilted */
    .hero-flowers__pos--2 {
    ...
    /* 3: Small, center bottom — squished + rotated */
    .hero-flowers__pos--3 {
    ...
    /* 4: Medium, center-right top — flipped, slight tilt */
    .hero-flowers__pos--4 {
    ...
    /* 5: Small, right bottom — tall + narrow, steep tilt */
    .hero-flowers__pos--5 {
    ...
    /* 6: Tiny, far-right bottom — wide + flat, flipped */
    .hero-flowers__pos--6 {
    ...
    /* ── Animation wrappers (translate only, never overrides parent) ── */
    ...
    /* Stagger delays via nth-child of pos wrappers */
    ...
    /* ── 3 distinct sway keyframes (translate + slight rotate) ── */
