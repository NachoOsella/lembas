...
@Component({
  ...
  styles: `
    ...
    .hero-flowers__leaf-shape { fill: currentColor; }
    ...
    .hero-flowers__anim--a { animation: sway-a 9s ease-in-out infinite; }
    .hero-flowers__anim--b { animation: sway-b 11s ease-in-out infinite; }
    .hero-flowers__anim--c { animation: sway-c 8s ease-in-out infinite; }

    .hero-flowers__pos--2 .hero-flowers__anim { animation-delay: 1s; }
    .hero-flowers__pos--3 .hero-flowers__anim { animation-delay: 0.5s; }
    .hero-flowers__pos--4 .hero-flowers__anim { animation-delay: 2s; }
    .hero-flowers__pos--5 .hero-flowers__anim { animation-delay: 1.5s; }
    ...
    @media (prefers-reduced-motion: reduce) {
      .hero-flowers__anim { animation: none !important; }
    }

    @media (max-width: 640px) {
      .hero-flowers__pos--4,
      .hero-flowers__pos--5,
      .hero-flowers__pos--6 { display: none; }
      .hero-flowers__pos--1 { width: 140px; height: 140px; }
      .hero-flowers__pos--2 { width: 100px; height: 100px; left: 10%; }
      .hero-flowers__pos--3 { width: 80px; height: 80px; left: 50%; }
    }
  `,
})
